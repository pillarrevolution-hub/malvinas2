            ...
            {r.capas.map((c, i) => {
              ...
              return (
                <div key={i} className="rounded-xl border border-slate-200 bg-slate-50/50 p-3">
                  <div className="grid gap-2 md:grid-cols-[auto_1fr_1fr] lg:grid-cols-[auto_1.2fr_1.6fr_0.7fr_0.6fr_0.9fr_0.8fr_1.1fr_auto]">
                    <div className="flex items-center gap-1">
                      <span className="w-4 text-sm font-bold">{i + 1}</span>
                    ...
                    <div>
                      <label className="label">Activo · dosis/toma (mg)</label>
                      <div className="flex gap-1">
                        <input className="input" value={c.activoReceta}
                          onChange={(e) => setCapa(i, { activoReceta: e.target.value })} />
                        <input className="input w-20" type="number" step="any" value={c.dosisMg ?? ''}
                    ...
                    <div>
                      ...
                      {c.tintaId === null && (
                        <input className="input mt-1" placeholder="Nombre de la tinta" value={c.tinta}
                    ...
                    <div>
                      ...
                      <p className={`py-1.5 text-sm font-bold ${calc?.bajoMinimo ? 'text-red-600' : 'text-teal-700'}`}>
                    ...
                    <button className="self-center text-red-500"
